...
describe('Scoreboard', () => {
  it('displays all player names and balances', () => {
    render(<Scoreboard game={makeGame()} onAddPlayer={vi.fn()} onEnd={vi.fn()} />)
  ...
  it('calls onEnd when End Game button is clicked', () => {
    const onEnd = vi.fn()
    render(<Scoreboard game={makeGame()} onAddPlayer={vi.fn()} onEnd={onEnd} />)
  ...
  it('allows entering a new player name and calls onAddPlayer', () => {
    ...
    render(<Scoreboard game={makeGame()} onAddPlayer={onAddPlayer} onEnd={vi.fn()} />)
